# Generated by Django 5.2.5 on 2026-02-14 09:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Студент'), ('teacher', 'Викладач'), ('admin', 'Адміністратор')], default='student', max_length=10, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(default='4 тижні', max_length=50, verbose_name='Тривалість')),
